...
class Ui_Dialog4(object):
    ...
    def get_length_value4(self):
        val_length4 = self.doubleSpinBox.value()
        # print(val_length4)
        return val_length4
    def get_diameter_1_4(self):
        val_diam_1_4 = self.doubleSpinBox_2.value()
        return val_diam_1_4
    def get_diameter_2_4(self):
        val_diam_2_4 = self.doubleSpinBox_3.value()
        return val_diam_2_4
    
    def get_angle4(self):
        return self.doubleSpinBox_angle.value()
    def get_cylinder_button4(self):
        shape_name_4 = self.pushButton.text()
        self.label_2.setText("Selected: {}".format(shape_name_4))
        ...
        return shape_name_4        
    def get_trapezoid_button4(self):
        shape_name_4 = self.pushButton_2.text()
        self.label_2.setText("Selected: {}".format(shape_name_4))
        ...
        return shape_name_4    
    def get_conic_button4(self):
        shape_name_4 = self.pushButton_3.text()
        self.label_2.setText("Selected: {}".format(shape_name_4))
        self.doubleSpinBox_3.setEnabled(False)
        self.label_8.setEnabled(False)
        self.doubleSpinBox_3.setValue(0)
        ...
        self.doubleSpinBox_angle.setValue(0)
        return shape_name_4 
    # def error_message4(self):
    #     if self.get_length_value4() == 0 or self.get_diameter_1_4() == 0 or self.get_diameter_2_4() == 0:
    #         msg = QMessageBox()
    ...
    def calculate_properties4(self):
        R_1_4 = self.get_diameter_1_4()/2
        R_2_4 = self.get_diameter_2_4()/2
        L_4 = self.get_length_value4()
        
        if self.label_2.text() == "Selected: Cylinder":
            volume_4 = np.pi*R_1_4**2*L_4
            surface_area_4 = 2*np.pi*R_1_4*L_4
    
        elif self.label_2.text() == "Selected: Cylindrical Trapezoid":
            volume_4 = (1/3)*np.pi*(R_1_4**2+R_1_4*R_2_4+R_2_4**2)*L_4
            surface_area_4 = np.pi*(R_1_4+R_2_4)*np.sqrt((R_1_4-R_2_4)**2+L_4**2)
        elif self.label_2.text() == "Selected: Conic":
            volume_4 = (1/3)*np.pi*R_1_4**2*L_4
            surface_area_4 = np.pi*R_1_4*np.sqrt(L_4**2+R_1_4**2)
        else:
            volume_4 = 0
            surface_area_4 = 0 
        return volume_4,surface_area_4
    def setupUi(self, Dialog):
        ...
        # self.buttonBox.accepted.connect(self.error_message4)
        self.buttonBox.rejected.connect(Dialog.reject) # type: ignore
        
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        ##
        self.doubleSpinBox.valueChanged.connect(self.get_length_value4)
        self.doubleSpinBox_2.valueChanged.connect(self.get_diameter_1_4)
        self.doubleSpinBox_3.valueChanged.connect(self.get_diameter_2_4)
        self.doubleSpinBox_angle.valueChanged.connect(self.get_angle4)
        ##
        self.pushButton.clicked.connect(self.get_cylinder_button4)
        self.pushButton_2.clicked.connect(self.get_trapezoid_button4)
        self.pushButton_3.clicked.connect(self.get_conic_button4)
        self.pushButton_4.clicked.connect(self.clear_values)
    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Slot4"))
        self.label_8.setText(_translate("Dialog", "Diameter 2 :"))
        self.label_7.setText(_translate("Dialog", "Diameter 1 :"))
        self.label.setText(_translate("Dialog", "SLOT 4"))
