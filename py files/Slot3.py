...
class Ui_Dialog3(object):
    ...
    def get_length_value3(self):
        val_length3 = self.doubleSpinBox.value()
        return val_length3
    def get_diameter_1_3(self):
        val_diam_1_3 = self.doubleSpinBox_2.value()
        return val_diam_1_3
    def get_diameter_2_3(self):
        val_diam_2_3 = self.doubleSpinBox_3.value()
        return val_diam_2_3
    
    def get_angle3(self):
        return self.doubleSpinBox_angle.value()
    
    def get_cylinder_button3(self):
        shape_name_3 = self.pushButton.text()
        self.label_2.setText("Selected: {}".format(shape_name_3))
        ...
        return shape_name_3        
    def get_trapezoid_button3(self):
        shape_name_3 = self.pushButton_2.text()
        self.label_2.setText("Selected: {}".format(shape_name_3))
        ...
        return shape_name_3    
    def get_conic_button3(self):
        shape_name_3 = self.pushButton_3.text()
        self.label_2.setText("Selected: {}".format(shape_name_3))
        self.doubleSpinBox_3.setEnabled(False)
        self.label_8.setEnabled(False)
        self.doubleSpinBox_3.setValue(0)
    ...
    # def error_message3(self):
    #     if self.get_length_value3() == 0 or self.get_diameter_1_3() == 0 or self.get_diameter_2_3() == 0:
    #         msg = QMessageBox()
    #         msg.setWindowTitle("Error")
    #         msg.setText("Please set values before click OK!")
    #         msg.setIcon(QMessageBox.Critical)
    #         x = msg.exec_()
    def calculate_properties3(self):
        R_1_3 = self.get_diameter_1_3()/2
        R_2_3 = self.get_diameter_2_3()/2
        L_3 = self.get_length_value3()
        
        if self.label_2.text() == "Selected: Cylinder":
            volume_3 = np.pi*R_1_3**2*L_3
            surface_area_3 = 2*np.pi*R_1_3*L_3
    
        elif self.label_2.text() == "Selected: Cylindrical Trapezoid":
            volume_3 = (1/3)*np.pi*(R_1_3**2+R_1_3*R_2_3+R_2_3**2)*L_3
            surface_area_3 = np.pi*(R_1_3+R_2_3)*np.sqrt((R_1_3-R_2_3)**2+L_3**2)
        elif self.label_2.text() == "Selected: Conic":
            volume_3 = (1/3)*np.pi*R_1_3**2*L_3
            surface_area_3 = np.pi*R_1_3*np.sqrt(L_3**2+R_1_3**2)
        else:
            volume_3 = 0
            surface_area_3 = 0 
        return volume_3,surface_area_3
    
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(332, 400)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(150, 360, 161, 31))
        ...
        # self.buttonBox.accepted.connect(self.error_message3)
        self.buttonBox.rejected.connect(Dialog.reject) # type: ignore
        QtCore.QMetaObject.connectSlotsByName(Dialog)
        ##
        self.doubleSpinBox.valueChanged.connect(self.get_length_value3)
        self.doubleSpinBox_2.valueChanged.connect(self.get_diameter_1_3)
        self.doubleSpinBox_3.valueChanged.connect(self.get_diameter_2_3)
        
        self.doubleSpinBox_angle.valueChanged.connect(self.get_angle3)
        self.pushButton.clicked.connect(self.get_cylinder_button3)
        self.pushButton_2.clicked.connect(self.get_trapezoid_button3)
        self.pushButton_3.clicked.connect(self.get_conic_button3)
        self.pushButton_4.clicked.connect(self.clear_values)
        ##
    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Slot3"))
        self.label_8.setText(_translate("Dialog", "Diameter 2 :"))
        self.label_7.setText(_translate("Dialog", "Diameter 1 :"))
        self.label.setText(_translate("Dialog", "SLOT 3"))
